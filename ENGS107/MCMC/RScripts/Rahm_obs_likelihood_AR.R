...
#       sea-level rise observations as described in Ruckert et al. (2017).
...
{ 
  ...
  model.out <- gmsl_r07(a = par[1], Teq = par[2], SL0 = par[3], tstep, Tg = hist.temp) # run the SLR model and name to output y.mod
  y.mod <- model.out
